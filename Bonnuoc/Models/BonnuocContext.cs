...
using Bonnuoc.Models.Mapping;

namespace Bonnuoc.Models
{
    public partial class BonnuocContext : DbContext
    {
        static BonnuocContext()
        {
            Database.SetInitializer<BonnuocContext>(null);
        }

        public BonnuocContext()
            : base("Name=BonnuocContext")
        {
        }
