...
namespace Bonnuoc.Controllers.Admin.Capacity
{
    public class CapacityadController : Controller
    {
        ...
        // GET: Capacityad
         ...
         public ActionResult Create(tblCapacity tblcapacity, FormCollection collection)
         {
             ...
             clsSitemap.CreateSitemap(StringClass.NameToTag(tblcapacity.Name)+"-dt" , id, "Capacity"); 
         ...
         public ActionResult Edit(tblCapacity tblcapacity, int id, FormCollection collection)
         {
             if (ModelState.IsValid)
             {
                 ...
                 db.SaveChanges();
                 clsSitemap.UpdateSitemap(StringClass.NameToTag(tblcapacity.Name) + "-dt", id.ToString(), "Capacity"); 
                 #region[Updatehistory]
