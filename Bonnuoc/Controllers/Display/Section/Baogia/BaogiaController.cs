...
namespace Bonnuoc.Controllers.Display.Section.Baogia
{
    public class BaogiaController : Controller
    {
        ...
        public ActionResult BaogiaDetail(string tag)
        {
            ...
            ViewBag.Description = "<meta name=\"description\" content=\"Bảng báo giá mới nhất dành cho sản phẩm " + tblgroupproduct.Name + " của siêu thị bồn nước bigsea dành cho quý khách hàng\"/>";
            ...
            for (int i = 0; i < listProduct.Count; i++)
            {
                ...
                chuoi += "<td class=\"Names\"><a href=\"/san-pham/" + listProduct[i].Tag + "\" title=\"" + listProduct[i].Name + "\">" + listProduct[i].Name + "</a> </td>";
