...
namespace Bonnuoc.Controllers.Display.Section.Contact
{
    public class ContactController : Controller
    {
        ...
        {
            ViewBag.Title = "<title>Liên hệ mua Bồn Nước</title>";
            ViewBag.Description = "<meta name=\"description\" content=\"Liên hệ của khách hàng khi mua sản phẩm bồn nước tại siêu thị bồn nước BIGSEA\"/>";
            ViewBag.Keyword = "<meta name=\"keywords\" content=\"Mua bồn nước, bồn nước chính hãng, liên hệ mua bồn\" /> ";
