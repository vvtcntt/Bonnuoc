...
using PagedList;
using PagedList.Mvc;
namespace Bonnuoc.Controllers.Display.Section.Agency
{
    public class AgencyController : Controller
    {
        ...
        public ActionResult ListAgency(int? page)
        {
            ...
            ViewBag.Name = "Danh sách nhà phân phối bồn nước chính hãng trên toàn quốc";
            ...
            ViewBag.Description = "<meta name=\"description\" content=\"Danh sách nhà phân phối bồn nước chính hãng trên toàn quốc của công ty SEABIG Việt Nam. ĐỊa chỉ cung cấp bồn nước Sơn Hà, Tân Á, Tân Mỹ, Toàn Mỹ...\"/>";
            ViewBag.Keyword = "<meta name=\"keywords\" content=\"Bồn nước toàn mỹ, bồn nước sơn hà, bồn nước tân á\" /> ";
        ...
        public ActionResult TagAgency(string tag, int? page)
        {
            ...
            ViewBag.canonical = "<link rel=\"canonical\" href=\"http://bonnuoc.vn/TagAgency/" + StringClass.NameToTag(chuoitag) + "\" />"; ;
            return View(listnews.ToPagedList(pageNumber, pageSize));
        }
        public ActionResult AngencyDetail(string tag)
        {
            ...
            string meta = "";
            ViewBag.canonical = "<link rel=\"canonical\" href=\"http://bonnuoc.vn/Nha-phan-phoi/" + StringClass.NameToTag(tag) + "\" />";

            meta += "<meta itemprop=\"name\" content=\"" + tblagency.Name + "\" />";
            meta += "<meta itemprop=\"url\" content=\"" + Request.Url.ToString() + "\" />";
            meta += "<meta itemprop=\"description\" content=\"" + tblagency.Description + "\" />";
            meta += "<meta itemprop=\"image\" content=\"http://bonnuoc.vn" + tblagency.Images + "\" />";
            meta += "<meta property=\"og:title\" content=\"" + tblagency.Name + "\" />";
            meta += "<meta property=\"og:type\" content=\"product\" />";
            meta += "<meta property=\"og:url\" content=\"" + Request.Url.ToString() + "\" />";
            meta += "<meta property=\"og:image\" content=\"http://bonnuoc.vn" + tblagency.Images + "\" />";
