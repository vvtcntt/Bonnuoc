...
namespace Bonnuoc.Controllers.Display.Product
{
    public class OrderController : Controller
    {
        ...
        public ActionResult Command(FormCollection collection, string tag)
        {
            if (collection["btnorder"] != null)
            {
                try
                {
                    ...
                    if (rdtt == "2")
                    {
                        chuoihtml += "<p style=\"font-size:12px; margin:5px 10px\">Hình thức thanh toán :<span style=\"font-weight:bold\">Nhận hàng và thanh toán tại BIGSEA</span></p>";
                    ...
                    chuoihtml += "<span style=\"font-size:12px; text-align:center; color:#FFF; line-height:40px; display:block\">Copyright (c) 2002 – 2015 BIGSEA VIET NAM. All Rights Reserved</span>";
                    chuoihtml += " </div>";
                    chuoihtml += "</div>";
                    chuoihtml += "</body>";
                    chuoihtml += "</html>";
        ...
        public ActionResult OrderIndex()
        {
            ...
            chuoicty += "<span class=\"sp1\">Địa chỉ:</span><span class=\"sp2\"> " + tblconfig.Address1 + "</span>";
            chuoicty += "</div>";
            chuoicty += " <div class=\"row_ttck1\">";
            chuoicty += "<span class=\"sp1\">Số điện thoại:</span><span class=\"sp2\"> " + tblconfig.Mobile1 + " - " + tblconfig.Hotline1 + "</span>";
            chuoicty += "</div>";
            chuoicty += "<div class=\"row_ttck1\">";
        ...
        public ActionResult DeleteOrder(int id)
        {
            ...
            for (int i = 0; i < giohang.CartItem.Count; i++)
            {
                ...
                chuoi1 += "<div class=\"Tear_OrderToolbar\">";
                chuoi1 += "<a href=\"/San-pham/" + giohang.CartItem[i].Tag + "\" title=\"" + giohang.CartItem[i].Name + "\" >";
                chuoi1 += "<img src=\"/" + giohang.CartItem[i].Images + "\" alt=\"" + giohang.CartItem[i].Name + "\">";
                chuoi1 += "</a>";
                chuoi1 += " <a href=\"/San-pham/" + giohang.CartItem[i].Tag + "\" title=\"" + giohang.CartItem[i].Name + "\" class=\"Name\"  > " + giohang.CartItem[i].Name + "</a><span>" + string.Format("{0:#,#}", giohang.CartItem[i].Price) + "đ</span>";
                chuoi1 += " <a href=\"\" class=\"Del\" onclick=\"javascript:return DeleteOrder(" + giohang.CartItem[i].id + ")\"></a></div>";
            }
